...
const bootstrapGridPageRoute = require("./bootstrapGridPage/bootstrapGridPageRoute")
const bootstrapAccordionPageRoute = require("./bootstrapAccordionPage/bootstrapAccordionPageRoute")
...
router.use("/mainRoute", bootstrapGridPageRoute);
router.use("/mainRoute", bootstrapAccordionPageRoute);
